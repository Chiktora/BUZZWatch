...
import board
import adafruit_dht
from BUZZWatch.raspberry_pi_code.config import OUTDOOR_DHT22_PIN

def test_outdoor_dht22():
    print("\nTesting Outdoor DHT22 Sensor (GPIO{0}):".format(OUTDOOR_DHT22_PIN))
    print("-" * 30)
    ...
    try:
        ...
        dht = adafruit_dht.DHT22(getattr(board, f'D{OUTDOOR_DHT22_PIN}'))
